...
import { AppColors, AppSpacing, useAppColors } from '@/constants/styles';
...
export default function Summary() {
  ...
  return (
    <LinearGradient
      colors={[colors.complete, colors.background]}
    ...
    >
      ...
      <Text style={[styles.hint, { color: colors.textMuted }]}>Great work! 💪</Text>
    </LinearGradient>
  );
}
